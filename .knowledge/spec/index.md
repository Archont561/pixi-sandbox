...
* [Every key pixi.toml and sandbox.lock.json may carry](/spec/configuration.md) - Full annotated config schema: [kit], [node], [policy], [doctor], [docs], plus the lockfile schema and defaults. _(⚠️ reasoned)_
...
* [Decision Log D1-D18](/spec/decisions.md) - Every design decision, the alternative rejected, why, and its status (decided / open / corrected). _(✅ ⚠️)_
